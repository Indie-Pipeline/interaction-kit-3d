...
2. Unpack the `addons/indiepipeline.interaction-kit-3d` folder into your `/addons` folder within the Godot project
...
@export var outline_shader: Shader = preload("res://addons/indiepipeline.interaction_kit_3d/src/outline/pixel_perfect_outline.gdshader")
